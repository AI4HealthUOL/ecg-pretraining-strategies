...
from .time_series_dataset_utils import MEMMAP_META_VERSION
...
class TimeSeriesDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, hparams):
        ...
        if(hparams.memmap_filename is not None):
            ...
            if(not "meta" in memmap_meta or version.parse(memmap_meta["meta"].item()["version"])<version.parse(MEMMAP_META_VERSION)):
