...
from clinical_ts.models.fm_ecg import (
    ECGFounderWrapper,
    ECGJEPAWrapper,
    Data2VecWrapper,
    DinoSRWrapper,
...
class Main_Lite_ECG(Main_Lite):
    def __init__(self,hparams):
        ...
        elif hparams.architecture == "data2vec":
            self.model = Data2VecWrapper(
                num_classes=num_classes,
                num_output_tokens=input_size_model,
                config_path=hparams.pretrained,
                eval_mode=hparams.eval_mode,
        ...
        elif hparams.architecture == "dinosr":
            self.model = DinoSRWrapper(
                num_classes=num_classes,
                num_output_tokens=input_size_model,
                config_path=hparams.pretrained,
                eval_mode=hparams.eval_mode,
        ...
        elif hparams.architecture == "jepa":
            self.model = JEPAWrapper(
                num_classes=num_classes,
                num_output_tokens=input_size_model,
                config_path=hparams.pretrained,
                eval_mode=hparams.eval_mode,
        ...
        elif hparams.architecture == "hubert_pp":
            self.model = HuBERT_PP_Wrapper(
                num_classes=num_classes,
                num_output_tokens=input_size_model,
                config_path=hparams.pretrained,
                eval_mode=hparams.eval_mode,
