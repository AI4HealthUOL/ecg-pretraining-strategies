...
from clinical_ts.ts.ema import (
...
from clinical_ts.ts.head import MLPHeadConfig, S4HeadConfig
from clinical_ts.mask.base import MaskingConfig
from clinical_ts.mask.jepa_multiblock_mask import JEPAMultiBlockMaskingConfig
...
def create_default_config():
    ...
    cs.store(group="ts/mask", name="jepa_multi_block_mask", node=JEPAMultiBlockMaskingConfig)
    ...
    #EMA
    cs.store(group="ts/ema", name="data2vec", node=EMATimeSeriesEncoderConfigData2Vec)
    cs.store(group="ts/ema", name="dinosr", node=EMATimeSeriesEncoderConfigDinoSR)
    cs.store(group="ts/ema", name="jepa", node=EMATimeSeriesEncoderConfigJEPA)
    cs.store(group="ts/ema", name="skkmeans", node=EMATimeSeriesEncoderConfigSinkhornKnoppKMeans)
