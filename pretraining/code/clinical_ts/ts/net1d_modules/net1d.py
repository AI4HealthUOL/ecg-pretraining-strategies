...
class Net1DModule(nn.Module):
    ...
    def __init__(self, in_channels, base_filters, ratio, filter_list, m_blocks_list, kernel_size, stride, groups_width, use_bn=True, use_do=True, return_features=False, verbose=False):
        super(Net1DModule, self).__init__()
    ...
    def forward(self, x):
        ...
        for stage in self.stage_list:
            out = stage(out)
        # out: (B, filter_list[-1], L')

        return out.transpose(1, 2)  # (B, L', filter_list[-1])
