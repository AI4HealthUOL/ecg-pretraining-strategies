...
############################################################################################################
def sanity_check(model, state_dict_pre, strict=False):
    """
    ...
    for k in list(state_dict.keys()):
        ...
        if((state_dict[k].cpu() != state_dict_pre[k].cpu()).all()):
            print("WARNING:",k, "was changed in linear classifier training.")
            pass_flag=False
